...
//   final Set<Post> likedPosts = {}; // keep track of liked posts
//   final Set<Post> savedPosts = {}; // new set for saved posts

//   @override
//   void initState() {
//     super.initState();
//     app.seedFeed(); // populate dummy posts
//   }
...
//         actions: [
//           IconButton(
//             icon: const Icon(Icons.bookmark), // Saved posts icon
//             onPressed: () {
//               // navigate to a saved posts page or show snackbar
//               ScaffoldMessenger.of(context).showSnackBar(
//                 SnackBar(content: Text('Saved posts: ${savedPosts.length}')),
//               );
//             },
//             iconSize: 20,
//             color: Colors.teal,
